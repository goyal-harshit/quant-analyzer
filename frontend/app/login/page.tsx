      ...
      <div className="w-full max-w-md glass p-8 rounded-xl shadow-xl space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="login-email" className="text-xs font-semibold text-textSub uppercase tracking-wider">Email Address</label>
          ...
          <div className="space-y-1.5">
            <label htmlFor="login-password" className="text-xs font-semibold text-textSub uppercase tracking-wider">Password</label>
            <div className="relative">
